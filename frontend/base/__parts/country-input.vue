  ...
  <div class="intl-tel-input allow-dropdown" @mouseleave="hideSubMenu = true;">
    <div class="flag-container">
      ...
      <ul class="country-list" v-show="!hideSubMenu">
        <li @click="currentCode = item.code;hideSubMenu = true;" v-for="item in frontCountriesArray"
        ...
        <li class="divider"></li>
        <li @click="currentCode = item.code;hideSubMenu = true;" v-for="item in countriesArray"
            :class="'country ' + (item.code == currentCode ? 'highlight' : '')">
          <div class="flag-box">
            <div :class="'iti-flag ' + item.code"></div>
          </div>
    ...
    <div class="inpt_w">
      <masked-input class="inpt i-phone" v-model="value" :mask="computeMask" :placeholder="$t('telephone')"
